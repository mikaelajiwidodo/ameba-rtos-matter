...
#define SW_WDG_RESET_SRC (AON_BIT_RSTF_WDG1 | AON_BIT_RSTF_WDG2 | AON_BIT_RSTF_WDG3 | AON_BIT_RSTF_WDG4)
#define HW_WDG_RESET_SRC (AON_BIT_RSTF_IWDG)
#define SW_RESET_SRC     (AON_BIT_RSTF_KM0_WARM2PERI | AON_BIT_RSTF_KM4_WARM2PERI | AON_BIT_RSTF_AP_WARM2PERI | AON_BIT_RSTF_LPSYS | AON_BIT_RSTF_NPSYS | AON_BIT_RSTF_APSYS)
#endif
