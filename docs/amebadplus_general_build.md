...
- [Ameba RTOS master SDK](#ameba-rtos-master-sdk)
...
#### Matter Build Commands

In this version, there are 3 matter build commands that can be used after Matter environment is activated:
...
Before starting to build Matter App, do not forget to activate the Matter environment
