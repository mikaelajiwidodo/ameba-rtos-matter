...
Get ameba-rtos v1.1 SDK + integrated patch + matter v1.5-sve patch (WIP!!!)
...
Navigate to the `ameba-rtos` directory:
    ...
    ./matter_setup.sh ameba-rtos v1.5-sve
...
### Make Matter Libraries and Final Firmware
